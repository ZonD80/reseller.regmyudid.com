 ...
 */
    function create_account($email, $password, $name = '', $company = '',$phone='',$data = null) {
        $to_db['name'] = $name;
        ...
        $to_db['added'] = $this->CONFIG['TIME'];
        if ($data) {
            $to_db['extra'] = var_export($data,true);
        }
...
// update cookie
                    setcookie('id', $this->account['id'], $this->CONFIG['TIME'] + 86400 * 365 * 10,null,null,true,true);
                    setcookie('hash', $this->account['pass_hash'], $this->CONFIG['TIME'] + 86400 * 365 * 10,null,null,true,true);
//ban here
